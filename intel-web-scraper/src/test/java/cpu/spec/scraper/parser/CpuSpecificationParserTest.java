...
class CpuSpecificationParserTest {
    ...
    void testExtractSpecificationSample() throws Exception {
        ...
        try {
            CpuSpecificationModel actual = CpuSpecificationParser.extractSpecification(driver, "https://ark.intel.com/content/www/us/en/ark/products/201900/intel-pentium-gold-g6405t-processor-4m-cache-3-50-ghz.html");
